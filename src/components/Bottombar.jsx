...
function Bottombar() {
    ...
    return(
        <div className="absolute left-[80px] right-[80px] bottom-5 z-10 flex justify-around rounded-[18px] bg-white px-4 py-3 shadow-lg">
                <button className="flex flex-col items-center gap-2 rounded-2xl bg-transparent text-sm text-gray-700 hover:text-black cursor-pointer"
                ...
                <button className="flex flex-col items-center gap-2 rounded-2xl bg-transparent text-sm text-gray-700 hover:text-black cursor-pointer"
                  onClick={() => nav('/saved')}>
                  <img src='/Heart.svg' width={30} height={30} />
                  <div>저장</div>
                </button>
                <button className="flex flex-col items-center gap-2 rounded-2xl bg-transparent text-sm text-gray-700 hover:text-black cursor-pointer"
                  onClick={() => nav('/mypage')}>
